...
# 1. Load dataset
# -----------------------------
dff = pd.read_csv("datasets/final_qrc_dataset.csv")
...
# -----------------------------
# 5. Train QRC by each ticker data
# -----------------------------
# Analytic (exact expectation values, no shot noise)
num_qubits = 6
n_trotter = 2
dt = 1/ n_trotter
